  ...
  const features = [
    {
      ...
      newPage: null,
      description:
        "Experience dynamic and interactive guided meditations that go beyond dry pre-recorded sessions.",
    ...
    },
    {
      ...
      newPage: null,
      description:
        "Monitor your progress with detailed stats, charts, and insights designed to enhance your practice.",
      svgContent: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
          ><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
            id="SVGRepo_tracerCarrier"
            stroke-linecap="round"
      ...
      <div class="flex justify-center items-center mb-4 md:mb-8">
        <svg
          ...
          ></g><g id="SVGRepo_iconCarrier">
            ...
            ></path>
            <path
              d="M256.001,50.831c-6.656,0-12.051-5.395-12.051-12.051V17.276c0-6.656,5.395-12.051,12.051-12.051 c6.655,0,12.051,5.395,12.051,12.051V38.78C268.053,45.436,262.656,50.831,256.001,50.831z"
            ></path>
            <path
              d="M324.473,72.026c-3.085,0-6.168-1.176-8.522-3.53c-4.706-4.706-4.706-12.337,0-17.044l15.205-15.205 c4.707-4.706,12.336-4.706,17.044,0c4.706,4.706,4.706,12.337,0,17.044l-15.205,15.205C330.641,70.85,327.558,72.026,324.473,72.026 z"
            ></path>
            <path
              d="M187.529,72.026c-3.084,0-6.169-1.176-8.522-3.53l-15.205-15.205c-4.706-4.706-4.706-12.337,0-17.044 c4.706-4.706,12.337-4.706,17.044,0l15.205,15.205c4.706,4.706,4.706,12.337,0,17.044C193.698,70.85,190.613,72.026,187.529,72.026z "
            ></path>
          </g></svg
        >
      </div>
  ...
  <div class="pt-20 pb-8 px-7">
    ...
    >
      {#each features as feature}
        <div class="card bg-white w-[270px] min-h-[200px] flex-none shadow-xl">
