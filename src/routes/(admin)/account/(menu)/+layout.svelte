  ...
  <div class="drawer-side">
    ...
    >
      <li>
        ...
        >
          <a href="/" class="grow">Ananda</a>
          <label for="admin-drawer" class="lg:hidden ml-3"> &#x2715; </label>
        </div>
      </li>
      <li>
        <a
          href="/account/meditate"
          class={adminSection === "meditate" ? "active" : ""}
        ...
        >
          <svg
            ...
            width="20"
            height="20"
            viewBox="0 0 63.805 63.805"
            fill="currentColor"
          >
            <path
              d="M31.686 0c5.02 0 9.089 4.069 9.089 9.089s-4.069 9.089-9.089 9.089-9.089-4.069-9.089-9.089S26.666 0 31.686 0zm26.81 48.961c-4.383-10.289-19.918-26.166-20.22-26.362-1.563-1.687-3.848-2.515-6.156-2.549v-.007h-.435v.007c-2.308.035-4.594.863-6.156 2.549-.302.196-15.838 16.073-20.221 26.362-1.071 2.516-.068 4.885 1.611 6.282-.416 1.38-.426 2.921.041 4.408.803 2.562 2.881 4.154 5.418 4.154h39.047c2.537 0 4.614-1.593 5.417-4.154.468-1.487.458-3.028.041-4.408 1.679-1.397 2.682-3.766 1.61-6.282zM17.23 47.34c1.864-3.046 3.989-5.831 6.299-8.511 0 2.764.08 9.679.219 10.307-.469-.121-4.823-1.218-6.518-1.796zm22.828 1.796c.138-.628.218-7.543.218-10.307 2.312 2.68 4.437 5.465 6.3 8.511-1.694.578-4.048 1.675-6.518 1.796z"
            />
          </svg>
          Meditate
        </a>
      ...
      <li>
        <a
          ...
          class={adminSection === "history" ? "active" : ""}
          on:click={closeDrawer}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
